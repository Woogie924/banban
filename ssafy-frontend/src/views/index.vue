<template>
  <div>
    ...
    <!-- <div id="down_Body">
      <v-btn large dark color="primary">일반</v-btn>
      <v-btn large dark color="red">사업자</v-btn>
    </div>-->
    <div class="text-center">
      <div
        v-ripple="{ center: true }"
        class="success--text text-center elevation-2 pa-12"
  ...
  methods: {
    ...
    test() {
      axios.defaults.headers.common[
        "Authorization"
      ] = `key=AAAA8fvy-ls:APA91bGWO0UCXWPWot0DNUz0qBzNZdm1p8OVwscXSPm5EqZOse_tlMSuPAQw8D3ZEBkAq_a7Vd1BuzBHteUydouwhsWAKeycbxYjmnL9i_cXc9rEubsJqhksV3mX3fUqxWhG0SRDjsao`;
      axios
